...
from backdoors.attack import Attack
from backdoors.synthesizers.synthesizer import Synthesizer
from backdoors.tasks.fl.fl_task import FederatedLearningTask
from backdoors.tasks.task import Task
from backdoors.utils.parameters import Params
from backdoors.utils.utils import create_logger, create_table
...
class Helper:
    ...
    def make_task(self):
        ...
        if self.params.fl:
            module_name = f'backdoors.tasks.fl.{name_lower}_task'
            path = f'backdoors.tasks/fl/{name_lower}_task.py'
        else:
            module_name = f'backdoors.tasks.{name_lower}_task'
            path = f'backdoors.tasks/{name_lower}_task.py'
        try:
    ...
    def make_synthesizer(self):
        ...
        module_name = f'backdoors.synthesizers.{name_lower}_synthesizer'
        try:
            ...
            raise ModuleNotFoundError(
                ...
                f'backdoors.synthesizers/{name_lower}_synthesizer.py')
